...
**Related:** [WORKFLOW_SEQUENCE_DIAGRAMS.md](./WORKFLOW_SEQUENCE_DIAGRAMS.md), [SPRINT_8A_3.md](./SPRINT_8A_3.md), [EVENT_CATALOG.md](./EVENT_CATALOG.md)
...
| Goal | Description |
|------|-------------|
| **Reproduce sequences** | Run flows documented in [WORKFLOW_SEQUENCE_DIAGRAMS.md](./WORKFLOW_SEQUENCE_DIAGRAMS.md) |
...
Same body as `POST /api/mission-control/:phone/workflow/advance` (see [SPRINT_8A_3.md](./SPRINT_8A_3.md)).
...
| Document | Purpose |
|----------|---------|
| [WORKFLOW_SEQUENCE_DIAGRAMS.md](./WORKFLOW_SEQUENCE_DIAGRAMS.md) | Sequence flows to reproduce |
| [SPRINT_8A_3.md](./SPRINT_8A_3.md) | Advance API contract |
