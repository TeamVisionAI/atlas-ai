...
1. **Meta WABA / Cloud API migration (Sprint 11.4)** — **Final production decision approved:** **786-752-8080** = dedicated Atlas AI production number; **proceed** with Cloud API migration on **Niovel Perez WABA**. WhatsApp Business App history on **8080** **not required to preserve**. **786-296-7254** (**Ana Perez**) **independent** — operational risk isolation. **Next:** execute [confirmed procedure](../deployment/sprint-11.4-meta-production.md#confirmed-procedure-atlas-mvp) ([final decision](../deployment/sprint-11.4-meta-production.md#final-production-decision-approved-2026-07-21), DOC-0701 v1.9). **Do not delete unused WABAs during migration.** Not an Atlas backend issue.
