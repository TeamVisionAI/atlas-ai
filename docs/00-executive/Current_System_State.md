...
1. **Meta WABA / production architecture (Sprint 11.4)** — **Architecture approved:** **786-752-8080** = Atlas AI production number (Cloud API migration via **Niovel Perez** WABA) — automation, AI, scheduling, future integrations. **786-296-7254** (**Ana Perez**) **unchanged** — protected day-to-day ops; out of scope for Atlas. **Next step:** API Setup → select **Niovel Perez / 8080** only ([production architecture](../deployment/sprint-11.4-meta-production.md#production-architecture-approved-2026-07-21), DOC-0701 v1.8). **Do not delete unused WABAs during migration.** Not an Atlas backend issue.
