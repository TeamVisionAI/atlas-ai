...
1. **Meta WABA selection (Sprint 11.4)** — WABA inventory **complete**. **Niovel Perez** → **786-752-8080** (Approved, MVP target); **Ana Perez** → **786-296-7254** (Approved). Meta-generated **Test WABA** is **disabled** — do not use. Cloud API onboarding failed because Meta auto-selected the Test WABA. **Before any WABA reassignment:** consult Meta AI, record guidance, compare with official Meta docs per [pre-change gate](../deployment/sprint-11.4-meta-production.md#pre-change-gate-consult-meta-ai-before-waba-reassignment) (DOC-0701 v1.6). Then explicitly select intended production WABA — do not rely on Meta auto-selection. **Do not delete unused WABAs during migration** ([migration policy](../deployment/sprint-11.4-meta-production.md#waba-migration-policy-do-not-delete-during-migration)). Not an Atlas backend issue.
