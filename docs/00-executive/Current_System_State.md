...
1. **Meta WABA selection (Sprint 11.4)** — WABA inventory **complete**. **Niovel Perez** → **786-752-8080** (Approved, MVP target); **Ana Perez** → **786-296-7254** (Approved). Meta-generated **Test WABA** is **disabled** — do not use. Cloud API onboarding failed because Meta auto-selected the Test WABA. **Before retry:** explicitly select intended production WABA per [deployment checklist](../deployment/sprint-11.4-meta-production.md#deployment-checklist-before-cloud-api-onboarding) (DOC-0701 v1.5) — do not rely on Meta auto-selection. **Do not delete unused WABAs during migration** ([migration policy](../deployment/sprint-11.4-meta-production.md#waba-migration-policy-do-not-delete-during-migration)). Not an Atlas backend issue.
