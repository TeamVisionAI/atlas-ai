...
**Related:** [BUSINESS_RULES.md](./BUSINESS_RULES.md), [WORKFLOW_ENGINE_SPEC.md](./WORKFLOW_ENGINE_SPEC.md), [MILESTONE_DEFINITIONS.md](./MILESTONE_DEFINITIONS.md), [EVENT_CATALOG.md](./EVENT_CATALOG.md)
...
Sprint 8A introduces a **canonical milestone enum** (see [MILESTONE_DEFINITIONS.md](./MILESTONE_DEFINITIONS.md)) while **mapping** to existing fields during migration.
...
| [MILESTONE_DEFINITIONS.md](./MILESTONE_DEFINITIONS.md) | Per-milestone specification |
| [EVENT_CATALOG.md](./EVENT_CATALOG.md) | Auditable events and payloads |
