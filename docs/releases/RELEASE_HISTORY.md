...
**Related:** [ROADMAP.md](../roadmap/ROADMAP.md) · [ATLAS_PLATFORM_V1.md](../architecture/ATLAS_PLATFORM_V1.md)
...
| #4 | Agent Architecture (design) | `docs/architecture/ATLAS_AGENT_ARCHITECTURE.md` |
...
**Docs:** [RELEASE_1_1.md](./RELEASE_1_1.md)
...
**Commit:** `5939e6a`  
**Git Tag:** —  
**Docs:** [RELEASE_1_2.md](./RELEASE_1_2.md)
...
**Commit:** `b90663c`  
**Git Tag:** `v1.3.0`  
**Docs:** [RELEASE_1_3.md](./RELEASE_1_3.md)
...
- RFC: [RFC-008](../rfcs/RFC-008-daily-brief-schema.md)
...
**Commit:** `b6a868f`  
**Git Tag:** `v1.4.0`  
**Docs:** [RELEASE_1_4.md](./RELEASE_1_4.md)
...
- RFC: [RFC-009](../rfcs/RFC-009-mission-control-state.md)
...
- [ATLAS_PLATFORM_V1.md](../architecture/ATLAS_PLATFORM_V1.md)
- [WHY_ATLAS_EXISTS.md](../vision/WHY_ATLAS_EXISTS.md)
