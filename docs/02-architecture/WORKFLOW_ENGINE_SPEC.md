...
**Related:** [ATLAS_CORE_ARCHITECTURE.md](./ATLAS_CORE_ARCHITECTURE.md), [MILESTONE_DEFINITIONS.md](../06-business/MILESTONE_DEFINITIONS.md), [EVENT_CATALOG.md](../06-business/EVENT_CATALOG.md), [BUSINESS_RULES.md](../06-business/BUSINESS_RULES.md)
...
Milestones are the **single progress axis** for workflow logic. See [MILESTONE_DEFINITIONS.md](../06-business/MILESTONE_DEFINITIONS.md) for full definitions.
...
**Human advancement (BR-035):** Any milestone may transition to any **valid** target per the allowed-next table in [MILESTONE_DEFINITIONS.md](../06-business/MILESTONE_DEFINITIONS.md), subject to required-data validation.
...
4. On successful save:
   ...
   - Emit timeline/workflow events (see [EVENT_CATALOG.md](../06-business/EVENT_CATALOG.md))
