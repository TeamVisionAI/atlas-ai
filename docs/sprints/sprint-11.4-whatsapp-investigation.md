...
|----------|-------------|
| [Sprint-11.4.md](../05-sprints/Sprint-11.4.md) | Sprint 11.4 specification (DOC-0511) |
| [sprint-11.4-meta-production.md](../deployment/sprint-11.4-meta-production.md) | Meta WABA / Cloud API production troubleshooting (DOC-0701) |
| [whatsapp-cloud-api-migration-checklist.md](../deployment/whatsapp-cloud-api-migration-checklist.md) | Cloud API migration checklist — **deferred** (DOC-0702) |
| [../architecture/atlas-communication-platform.md](../architecture/atlas-communication-platform.md) | Atlas Communication Platform architecture — Sprint 12 (DOC-0020)
...
Operational detail and incident timeline: [DOC-0701](../deployment/sprint-11.4-meta-production.md).
...
See [wabaID incident](../deployment/sprint-11.4-meta-production.md#incident-unexpected-null-value-for-wabaid-2026-07-21) (DOC-0701).

**Secondary failure — new WABA recovery path**

A second recovery attempt followed [Meta AI guidance](../deployment/sprint-11.4-meta-production.md#meta-ai-recovery-strategy--new-waba-proposed-2026-07-21): create a brand-new WABA under the same portfolio.
...
Reference: [Communication Hub](../02-architecture/Communication_Hub.md) (DOC-0010) · [Atlas Communication Platform](../architecture/atlas-communication-platform.md) (DOC-0020).
