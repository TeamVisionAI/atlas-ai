...
|-------------|----------|-------------|
| DOC-0511 | [09-releases/sprints/Sprint-11.4.md](./Sprint-11.4.md) | Sprint specification and acceptance criteria |
| DOC-0010 | [Communication_Hub.md](../../02-architecture/Communication_Hub.md) | Communication Hub architecture |
| DOC-0001 | [00-executive/Current_System_State.md](../../00-executive/Current_System_State.md) | Production baseline (Release-11.3.1) |
| — | [09-releases/sprints/SPRINT_11_1_LIVE_WHATSAPP.md](SPRINT_11_1_LIVE_WHATSAPP.md) | Live WhatsApp pipeline (do not bypass layers) |
| — | [EVENT_CATALOG.md](../../06-business/EVENT_CATALOG.md) | Workflow event types |
| — | [BUSINESS_RULES.md](../../06-business/BUSINESS_RULES.md) | BR-001+ source of truth |
...
Per [09-releases/sprints/SPRINT_11_1_LIVE_WHATSAPP.md](SPRINT_11_1_LIVE_WHATSAPP.md):
