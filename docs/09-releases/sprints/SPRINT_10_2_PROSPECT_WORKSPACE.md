...
**Related:** [ATLAS_CORE_ARCHITECTURE.md](../../02-architecture/ATLAS_CORE_ARCHITECTURE.md) § Prospect Workspace
...
- **Performance:** Workspace GET includes `activityPreview` (≤ 5); full feed paginated. See [ENGINEERING_STANDARDS.md](../../03-engineering/ENGINEERING_STANDARDS.md).
