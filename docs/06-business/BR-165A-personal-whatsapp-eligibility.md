...
Atlas may auto-reply only when positive Atlas eligibility exists, including a verified CTWA ad referral, verified QR attribution, valid active campaign intake code, explicit `atlasAutomationEnabled=true`, or a still-active continuation whose persisted eligibility source was earned from one of those verified paths.
