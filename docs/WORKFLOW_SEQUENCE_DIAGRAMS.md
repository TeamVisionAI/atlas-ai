...
**Related:** [WORKFLOW_ENGINE_SPEC.md](./WORKFLOW_ENGINE_SPEC.md), [MILESTONE_DEFINITIONS.md](./MILESTONE_DEFINITIONS.md), [EVENT_CATALOG.md](./EVENT_CATALOG.md), [BUSINESS_RULES.md](./BUSINESS_RULES.md), [ATLAS_GLOSSARY.md](./ATLAS_GLOSSARY.md)
...
| Events | Structured entries in `workflow_events` (see [EVENT_CATALOG.md](./EVENT_CATALOG.md)) |
...
| Document | Purpose |
|----------|---------|
| [WORKFLOW_SIMULATOR_SPEC.md](./WORKFLOW_SIMULATOR_SPEC.md) | Developer simulator for testing these sequences |
| [SPRINT_8A_3.md](./SPRINT_8A_3.md) | Human Advancement API |
| [EVENT_CATALOG.md](./EVENT_CATALOG.md) | Event payloads |
