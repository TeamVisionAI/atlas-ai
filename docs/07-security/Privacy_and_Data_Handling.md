...
|-------------|----------|-------------|
| DOC-0001 | [00-executive/Current_System_State.md](../00-executive/Current_System_State.md) | Authoritative production state reference |
...
This section summarizes security controls relevant to privacy and data handling. For the full security table, see [05-integrations/meta/Meta_Approval_Portfolio.md — Section 13](../05-integrations/meta/Meta_Approval_Portfolio.md#13-security-overview) (DOC-0002).
