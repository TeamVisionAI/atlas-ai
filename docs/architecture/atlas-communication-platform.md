...
|----------|-------------|
| [sprint-11.4-whatsapp-investigation.md](../sprints/sprint-11.4-whatsapp-investigation.md) | Strategic pivot to multichannel MVP (DOC-0513) |
| [Communication_Hub.md](../02-architecture/Communication_Hub.md) | Communication Hub transport layer (DOC-0010) |
...
Implementation detail for the transport layer: [Communication Hub](../02-architecture/Communication_Hub.md) (DOC-0010).
