...
**Related:** [02-architecture/ATLAS_AGENT_ARCHITECTURE.md](../02-architecture/ATLAS_AGENT_ARCHITECTURE.md), [ATLAS_CORE_ARCHITECTURE.md](../02-architecture/ATLAS_CORE_ARCHITECTURE.md), [02-architecture/atlas-communication-platform.md](../02-architecture/atlas-communication-platform.md), [BUSINESS_RULES.md](../06-business/BUSINESS_RULES.md), [EVENT_CATALOG.md](../06-business/EVENT_CATALOG.md)
...
These align with the Atlas Constitution and [02-architecture/ATLAS_AGENT_ARCHITECTURE.md](../02-architecture/ATLAS_AGENT_ARCHITECTURE.md).
