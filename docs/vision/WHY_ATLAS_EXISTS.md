...
**Related:** [ATLAS_NEVER_SLEEPS.md](./ATLAS_NEVER_SLEEPS.md), [../architecture/ATLAS_PLATFORM_V1.md](../architecture/ATLAS_PLATFORM_V1.md), [../roadmap/ROADMAP.md](../roadmap/ROADMAP.md)
...
See [RFC-010 Event Bus Principles](../rfcs/RFC-010-event-bus-principles.md).
...
- **Business rules are authoritative** — see [BUSINESS_RULES.md](../BUSINESS_RULES.md)
