/**
 * Sprint 15.0 — Shared Business Event → Mission Control projection operation.
 */
 ...
 * @param {import('../infrastructure/MissionControlRepository').MissionControlRepository} repository
 * @param {Object} [options]
 * @param {boolean} [options.skipIdempotencyCheck]
 * @returns {Promise<Object>}
 */
async function projectMissionControlEvent(businessEvent, repository, options = {}) {
