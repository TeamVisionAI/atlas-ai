...
const INTENTS = Object.freeze({
  ...
  /** BR-143 — IUL review ad / policy_review conversation. */
  IUL_GREETING: "iul_greeting",
  IUL_POLICY_ACTIVE_YES: "iul_policy_active_yes",
  IUL_POLICY_ACTIVE_NO: "iul_policy_active_no",
  /** BR-143 discovery A–F */
  IUL_POLICY_TYPE: "iul_policy_type",
  IUL_CARRIER: "iul_carrier",
  IUL_ORIGINAL_POLICY_PURPOSE: "iul_original_policy_purpose",
  IUL_POLICY_AGE: "iul_policy_age",
  IUL_REVIEW_REASON: "iul_review_reason",
  IUL_DOCUMENTS_AVAILABLE: "iul_documents_available",
  IUL_POLICY_IS_BAD_QUESTION: "iul_policy_is_bad_question",
  IUL_CHOOSE_REVIEW_TOPIC: "iul_choose_review_topic",
  IUL_CHOOSE_REVIEW_DAY_PART: "iul_choose_review_day_part",
  IUL_CHOOSE_REVIEW_DAY: "iul_choose_review_day",
  IUL_CHOOSE_MEETING_MODE: "iul_choose_meeting_mode",
...
const NEXT_ACTIONS = Object.freeze({
  ...
  /** BR-143 — IUL-ad track; never books. */
  IUL_ASK_POLICY_ACTIVE: "iul_ask_policy_active",
  IUL_ASK_POLICY_TYPE: "iul_ask_policy_type",
  IUL_ASK_CARRIER: "iul_ask_carrier",
  IUL_ASK_ORIGINAL_PURPOSE: "iul_ask_original_purpose",
  IUL_ASK_POLICY_AGE: "iul_ask_policy_age",
  ...
  IUL_ASK_MEETING_MODE: "iul_ask_meeting_mode",
  IUL_CAPTURE_REVIEW_DAY_PART: "iul_capture_review_day_part",
  IUL_ANSWER_THEN_REVIEW: "iul_answer_then_review",
  IUL_OFFER_REVIEW_SLOTS: "iul_offer_review_slots",
  IUL_CREATE_REVIEW_APPOINTMENT: "iul_create_review_appointment",
  /** BR-209 — no real slots in the scheduling horizon. */
  IUL_SCHEDULING_UNAVAILABLE: "iul_scheduling_unavailable",
...
const REASON_CODES = Object.freeze({
  ...
  LOCATION_OVERWRITE_BLOCKED: "LOCATION_OVERWRITE_BLOCKED",
  ...
  /** BR-131 — no prior Atlas question in this conversation → first-turn, never resume. */
  FIRST_TURN_PRECEDENCE_NO_PRIOR_QUESTION:
    "FIRST_TURN_PRECEDENCE_NO_PRIOR_QUESTION",
  ...
  /** Confirmation-time recheck: selected slot taken; offer fresh replacements. */
  SELECTED_SLOT_NO_LONGER_AVAILABLE: "SELECTED_SLOT_NO_LONGER_AVAILABLE",
  CONCURRENT_APPOINTMENT_ADOPTED: "CONCURRENT_APPOINTMENT_ADOPTED",
  ...
  /** BR-164 — exact requested wall-clock is available; confirm that slot only. */
  EXACT_REQUESTED_TIME_CONFIRMED: "EXACT_REQUESTED_TIME_CONFIRMED",
  /** BR-164 — FAQ answered, resume at next unresolved fact. */
  FAQ_RESUME_NEXT_UNRESOLVED: "FAQ_RESUME_NEXT_UNRESOLVED",
  /** BR-164 — no silent terminal; every turn is respond|wait|suppress. */
  NO_SILENT_TERMINAL: "NO_SILENT_TERMINAL",
  ...
  DAY_FIRST_DAYPART_SLOT_HONESTY: "DAY_FIRST_DAYPART_SLOT_HONESTY",
  ...
  FAQ_RESUME_FAILURE: "FAQ_RESUME_FAILURE",
  ...
  /** BR-143 */
  IUL_AD_CONVERSATION: "IUL_AD_CONVERSATION",
  ...
  IUL_ORIGINAL_PURPOSE_CAPTURED: "IUL_ORIGINAL_PURPOSE_CAPTURED",
  IUL_POLICY_AGE_CAPTURED: "IUL_POLICY_AGE_CAPTURED",
  IUL_REVIEW_REASON_CAPTURED: "IUL_REVIEW_REASON_CAPTURED",
  IUL_DOCUMENTS_CAPTURED: "IUL_DOCUMENTS_CAPTURED",
  IUL_DISCOVERY_COMPLETE: "IUL_DISCOVERY_COMPLETE",
  IUL_POLICY_REVIEW_SCHEDULING: "IUL_POLICY_REVIEW_SCHEDULING",
  IUL_DAYPART_FALLBACK_OFFERED: "IUL_DAYPART_FALLBACK_OFFERED",
  IUL_NO_AVAILABILITY: "IUL_NO_AVAILABILITY",
  IUL_SLOT_INTERACTIVE_OFFERED: "IUL_SLOT_INTERACTIVE_OFFERED",
  IUL_STALE_SLOT_REJECTED: "IUL_STALE_SLOT_REJECTED",
  ...
  IUL_ZOOM_LINK_MISSING: "IUL_ZOOM_LINK_MISSING",
  ...
  /** BR-222 — fresh IUL intake restarted the episode. */
  IUL_FRESH_EPISODE_RESET: "IUL_FRESH_EPISODE_RESET",
  /** BR-222 — confirmed policy-review appointment kept on fresh intake. */
  IUL_CONFIRMED_APPOINTMENT_PRESERVED: "IUL_CONFIRMED_APPOINTMENT_PRESERVED",
  ...
  IUL_TOPIC_CAPTURED: "IUL_TOPIC_CAPTURED",
  IUL_SOFT_APPOINTMENT_ASK: "IUL_SOFT_APPOINTMENT_ASK",
  IUL_REVIEW_WINDOW_CAPTURED: "IUL_REVIEW_WINDOW_CAPTURED",
  IUL_INFO_THEN_REVIEW: "IUL_INFO_THEN_REVIEW",
  IUL_NO_OBLIGATION: "IUL_NO_OBLIGATION",
  IUL_NOT_JUST_INVESTMENT: "IUL_NOT_JUST_INVESTMENT",
  IUL_NO_AGENT_ARGUMENT: "IUL_NO_AGENT_ARGUMENT",
  IUL_WHATSAPP_BASICS_ONLY: "IUL_WHATSAPP_BASICS_ONLY",
  IUL_PRIMERICA_TRANSPARENT: "IUL_PRIMERICA_TRANSPARENT",
  IUL_REVIEW_IS_FREE: "IUL_REVIEW_IS_FREE",
