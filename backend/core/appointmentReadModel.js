...
function rowToAppointment(row) {
  ...
  return {
    ...
    agendaContactId: row.agenda_contact_id || row.agendaContactId || null,
    prospectPhone: row.prospect_phone || row.prospectPhone || null,
...
function appointmentToRow(appointment) {
  ...
  return {
    ...
    agenda_contact_id: appointment.agendaContactId || null,
    prospect_phone: appointment.prospectPhone || null,
